        ...
        1: [function(e, t, n) {
            ...
            !function() {
                ...
                o.scale = function(e, t, n, r) {
                    ...
                    e.isStatic || (o.setMass(e, e.density * s),
                    o.setInertia(e, a))),
                            ...
                            if (!f.region || m.id !== f.region.id || i) {
                                ...
                                for (s = v.startCol; s <= v.endCol; s++)
                                    for (a = v.startRow; a <= v.endRow; a++) {
                                        ...
                                        (f.region === m || y && !g || i) && (l || (l = o._createBucket(u, c)),
            ...
            !function() {
                ...
                o.update = function(e, t, n) {
                    ...
                    l = 0; l < t.length; l++)
                        ...
                        m.push(s),
                        a = d[s],
                        a ? (a.isActive ? f.push(a) : u.push(a),
                    ...
                    for (l = 0; l < c.length; l++)
                        a = c[l],
                        a.isActive && -1 === r.indexOf(m, a.id) && (i.setActive(a, !1, n),
                        p.push(a))
                }
                ,
                o.removeOld = function(e, t) {
                    ...
                    for (s = 0; s < a.length; s++)
                        n = a[s],
                        i = n.collision,
                        i.bodyA.isSleeping || i.bodyB.isSleeping ? n.timeUpdated = t : t - n.timeUpdated > o._pairMaxIdleLife && c.push(s);
            ...
            !function() {
                ...
                o.solvePosition = function(e, t) {
                    ...
                    for (n = 0; n < e.length; n++)
                        ...
                        l = s.parentB,
                        c = s.normal,
                        d = r.sub(r.add(l.positionImpulse, l.position, f), r.add(a.positionImpulse, r.sub(l.position, s.penetration, m), v), y),
                        ...
                        if (f.isActive && !f.isSensor) {
                            ...
                            for (var w = 0; w < h.length; w++) {
                                var S = h[w]
                                  ...
                                  , L = _
                                  , F = 1 / 0;
                                T > f.friction * f.frictionStatic * E * n && (F = T,
                                L = s.clamp(f.friction * R * n, -F, F));
                                var O = r.cross(A, g)
                                  , q = r.cross(P, g)
            ...
            !function() {
                o.collides = function(e, t, n) {
                    ...
                    if (n && d) {
                        ...
                        if (l = o._overlapAxes(m.vertices, v.vertices, y),
                        c.reused = !0,
                        l.overlap <= 0)
                            return c.collided = !1,
                            c
                    } else {
                        if (s = o._overlapAxes(e.vertices, t.vertices, e.axes),
                        s.overlap <= 0)
                            return c.collided = !1,
                            c;
                        if (a = o._overlapAxes(t.vertices, e.vertices, t.axes),
                        a.overlap <= 0)
                            return c.collided = !1,
                            c;
                    ...
                    var g = o._findSupports(e, t, c.normal)
                      , x = [];
                    if (i.contains(e.vertices, g[0]) && x.push(g[0]),
            ...
            !function() {
                ...
                o.solve = function(e, t) {
                    ...
                    if (n || i) {
                        ...
                        e.angleA = n.angle),
                        i && !i.isStatic && (r.rotate(a, i.angle - e.angleB, a),
                        e.angleB = i.angle);
                        var l = s
                          , c = a;
                        ...
                        l && c) {
                            ...
                            if (e.damping) {
                                var C = r.create();
                                m = r.div(d, u),
                                y = r.sub(i && r.sub(i.position, i.positionPrev) || C, n && r.sub(n.position, n.positionPrev) || C),
                                v = r.dot(m, y)
                            }
                            ...
                            n.position.x -= h.x * f,
                            n.position.y -= h.y * f,
                            e.damping && (n.positionPrev.x -= e.damping * m.x * v * f,
                            n.positionPrev.y -= e.damping * m.y * v * f),
                            p = r.cross(s, h) / S * o._torqueDampen * n.inverseInertia * (1 - e.angularStiffness),
                            ...
                            i.position.x += h.x * f,
                            i.position.y += h.y * f,
                            e.damping && (i.positionPrev.x += e.damping * m.x * v * f,
                            i.positionPrev.y += e.damping * m.y * v * f),
                            p = r.cross(a, h) / S * o._torqueDampen * i.inverseInertia * (1 - e.angularStiffness),
                    ...
                    for (var t = 0; t < e.length; t++) {
                        ...
                        if (!(n.isStatic || 0 === c.x && 0 === c.y && 0 === c.angle)) {
                            ...
                            for (var d = 0; d < n.parts.length; d++) {
                                ...
                                u.position.y += c.y),
                                0 !== c.angle && (i.rotate(u.vertices, c.angle, n.position),
        ...
        15: [function(e, t, n) {
            ...
            !function() {
                ...
                o.update = function(e, t, n) {
                    ...
                    for (e.enableSleeping && r.update(y, c.timeScale),
                    o._bodiesApplyGravity(y, a.gravity),
                    o._bodiesUpdate(y, t, c.timeScale, n, a.bounds),
                    p.preSolveAll(y),
                    i = 0; i < e.constraintIterations; i++)
                        p.solveAll(g, c.timeScale);
                    p.postSolveAll(y),
                    f.controller ? (a.isModified && f.controller.clear(f),
                    ...
                    i = 0; i < e.positionIterations; i++)
                        s.solvePosition(h.list, c.timeScale);
                    for (s.postSolvePosition(y),
                    p.preSolveAll(y),
                    i = 0; i < e.constraintIterations; i++)
                        p.solveAll(g, c.timeScale);
                    for (p.postSolveAll(y),
                    s.preSolveVelocity(h.list),
                    i = 0; i < e.velocityIterations; i++)
        ...
        23: [function(e, t, n) {
            ...
            !function() {
                ...
                o.polygon = function(e, t, n, i, l) {
                    ...
                    if (l.chamfer) {
                        var g = l.chamfer;
                        y.vertices = r.chamfer(y.vertices, g.radius, g.quality, g.qualityMin, g.qualityMax),
                        delete l.chamfer
                    }
                ...
                o.fromVertices = function(e, t, n, o, d, u, p) {
                    ...
                    u = void 0 !== u ? u : .01,
                    p = void 0 !== p ? p : 10,
                    i || s.warn("Bodies.fromVertices: poly-decomp.js required. Could not decompose vertices. Fallback to convex hull."),
                    s.isArray(n[0]) || (n = [n]),
                    b = 0; b < n.length; b += 1)
                        if (y = n[b],
                        (v = r.isConvex(y)) || !i)
                            ...
                            i.makeCCW(S),
                            !1 !== u && i.removeCollinearPoints(S, u);
        ...
        31: [function(e, t, n) {
            ...
            !function() {
                ...
                o.collisions = function(e, t, n) {
                    ...
                    r = 0; r < t.length; r++)
                        ...
                        o.activeContacts.length > 0)) {
                            ...
                            2 === o.activeContacts.length && (u = (o.activeContacts[0].vertex.x + o.activeContacts[1].vertex.x) / 2,
                            p = (o.activeContacts[0].vertex.y + o.activeContacts[1].vertex.y) / 2),
                            i.bodyB === i.supports[0].body || !0 === i.bodyA.isStatic ? a.moveTo(u - 8 * i.normal.x, p - 8 * i.normal.y) : a.moveTo(u + 8 * i.normal.x, p + 8 * i.normal.y),
                            a.lineTo(u, p)
                        }
                ...
                var n = function(e, t) {
                  ...
                  , p = function(e, t) {
                    var n = e.textures[t];
                    return n || (n = e.textures[t] = new Image,
                    n.src = t,
                    n)
                }
                  , f = function(e, t) {
